...
GENERIC_RECORDS = [
    {"path": "m_nItemPricePerTier[0]", "value": 0},
    {"path": "m_nItemPricePerTier[1]", "value": 800},
    {"path": "m_nItemPricePerTier[2]", "value": 1600},
]
ABILITY_RECORDS = [
    {"path": "upgrade_a.m_iItemTier", "value": "EModTier_1"},
    {"path": "upgrade_a.m_eItemSlotType", "value": "EItemSlotType_Weapon"},
    {"path": "upgrade_a.m_eShopFilters", "value": "EShopFilterDPS"},
    {"path": "upgrade_b.m_iItemTier", "value": "EModTier_2"},
    {"path": "upgrade_b.m_eItemSlotType", "value": "EItemSlotType_Armor"},
    {"path": "upgrade_b.m_bDisabled", "value": "true"},
    {"path": "upgrade_b.m_vecComponentItems[0]", "value": "upgrade_a"},
    {"path": "not_an_item.m_eAbilityType", "value": "EAbilityType_Item"},
]


class DescribePrices:
    def it_reads_the_tier_price_table(self):
        assert prices(GENERIC_RECORDS) == {0: 0, 1: 800, 2: 1600}


class DescribeItems:
    def it_joins_tier_to_cost_strips_prefixes_and_normalizes_disabled(self):
        assert items(ABILITY_RECORDS, prices(GENERIC_RECORDS)) == [
...
class DescribeRender:
    def it_emits_tsv_sorted_by_name_with_header(self):
        assert render(items(ABILITY_RECORDS, prices(GENERIC_RECORDS))) == (
